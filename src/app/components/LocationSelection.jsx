...
// location data
const locations = [
  "Otogar (AŞTİ), Emek, Ankara, Türkiye",
  "Tren Garı, Ulus, Ankara, Türkiye",
  "Tunalı Hilmi Caddesi, Çankaya, Ankara, Türkiye",
  "Esenboğa Havalimanı, Akyurt, Ankara, Türkiye",
];

export default function LocationSelection() {
  const [location, setLocation] = useState("En uygun lokasyonu seç");
  return (
