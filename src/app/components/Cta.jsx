          ...
          <div className="flex-1 xl:ml-24 text-center md:text-left mb-12 md:mb-0">
            <div className="max-w-[520px] mx-auto order-2 xl:order-none">
              <motion.h2
                ...
                className="h2"
              >
                Şimdi Uygulamamızı indirin ve kolaylıkla yola çıkın!
              </motion.h2>
              <motion.p
              ...
              >
                ...
                eligendi sint nemo, ad architecto voluptates dolore earum
                explicabo sapiente autem officiis odit, eveniet delectus
                suscipit adipisci deleniti, libero dolorum distinctio?
              </motion.p>
              <motion.div
